...
def process_tree(crassvirales_taxa_df, taxa_groups, outdir, tree_file):
...
def main():
    ...
    # set outdir
    outdir = "/home/danielc/projects/Bas_phages/5_nr_screening/4_merged_ncbi_crassvirales/4_MRCAs"
    ...
    part = partial(process_tree, crassvirales_taxa_df, taxa_groups, outdir)
    ...
    #     print(tree_file)
    #     process_tree(crassvirales_taxa_df, taxa_groups, outdir, tree_file)
